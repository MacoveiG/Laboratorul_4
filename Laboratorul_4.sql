...
INSERT INTO carte(id, denumire, autor, an)
    VALUES (1, 'Dennumire1', 'Autor1', 1901);
INSERT INTO carte(id, denumire, autor, an)
    VALUES (2, 'Dennumire2', 'Autor2', 1902);
INSERT INTO carte(id, denumire, autor, an)
    VALUES (3, 'Dennumire3', 'Autor3', 1903);
INSERT INTO carte(id, denumire, autor, an)
    VALUES (4, 'Dennumire4', 'Autor4', 1904);
INSERT INTO carte(id, denumire, autor, an)
    VALUES (5, 'Dennumire5', 'Autor5', 1905);
INSERT INTO carte(id, denumire, autor, an)
    VALUES (6, 'Dennumire6', 'Autor6', 1906);
...
SELECT * FROM adresa WHERE id = 2;
SELECT * FROM adresa WHERE tara = 'Moldova';
...
UPDATE persoana SET email = 'wqe11@mail.md' where id = 2;
UPDATE persoana SET email = 'wqe11@mail.com' where id = 2;
UPDATE adresa SET nr_apartament = 14 WHERE id = 4;
UPDATE persoana SET last_name = 'Test3333' WHERE id = 3;

-- Stergere

DELETE FROM carte WHERE an = 1901;
DELETE FROM carte WHERE an = 1904;
...
SELECT * FROM persoana INNER JOIN adresa on persoana.adresa_id = adresa.id WHERE persoana.email LIKE '%.com';
SELECT * FROM persoana LEFT JOIN adresa on persoana.adresa_id = adresa.id WHERE persoana.email LIKE '%gmail%';
SELECT * FROM persoana RIGHT JOIN adresa on persoana.adresa_id = adresa.id WHERE adresa.oras LIKE 'Ungheni';
SELECT * FROM persoana FULL JOIN adresa on persoana.adresa_id = adresa.id WHERE adresa.oras LIKE 'Chisinau';
